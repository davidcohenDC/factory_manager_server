...
const machineBodySchema = Joi.object({
  ...
  machineState: Joi.object({
    currentState: Joi.string()
      .valid('operational', 'stand-by', 'maintenance', 'anomaly', 'off')
      .required(),
...
const validateMachineBody = createValidationMiddleware(
  machineBodySchema,
  'body',
  'MachineValidation'
)
const validateMachineId = createValidationMiddleware(
  machineIdSchema,
  'params',
  'MachineValidation'
)
