...
const validateMachineSensorBody = createValidationMiddleware(
  machineSensorBodySchema,
  'body',
  logSource
)
const validateMachineSensorId = createValidationMiddleware(
  machineSensorIdSchema,
  'params',
  logSource
)
